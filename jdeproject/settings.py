"""
Django settings for jdeproject project.
...
SECRET_KEY = 'django-insecure-pw5pd+_52^7sr3b%1mu$+8y@nbdyg!o=9fd+w%d)q^qlx*$m%t'
...
WSGI_APPLICATION = 'jdeproject.wsgi.application'
